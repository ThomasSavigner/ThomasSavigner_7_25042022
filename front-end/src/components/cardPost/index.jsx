...
export default function Cardpost(props) {
  ...
  // Format article date
    ...
    return (
        ...
        <section className="card-position border border-dark mx-auto mt-1 color-4">
                ...
                <main className="p-0">
                  ...
                  <div className="px-1 color-4 px-2">
                ...
                <footer className="bg-color-3-opacity d-flex justify-content-end pt-1 border border-dark">
